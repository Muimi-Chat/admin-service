"""
Django settings for muimi_admin_api project.
...
ROOT_URLCONF = 'muimi_admin_api.urls'
...
WSGI_APPLICATION = 'muimi_admin_api.wsgi.application'
...
POSTGRES_ADDRESS = os.environ.get('POSTGRESQL_ADDRESS', 'admin-database')
